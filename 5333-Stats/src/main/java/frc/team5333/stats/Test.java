...
//        } catch (IOException e) { }
        Waypoint[] points = new Waypoint[] {
                new Waypoint(new Vec2D(-4, -2), 0),
                new Waypoint(new Vec2D(-1, 2), MathHelper.d2r(30)),
                new Waypoint(new Vec2D(3, 5), MathHelper.d2r(60)),
                new Waypoint(new Vec2D(5, 2), MathHelper.d2r(-45))
        };

        Trajectory traj = MotionPipeline.createTrajectory(points, new CubicHermite(), 30, 10, 5, 2);
